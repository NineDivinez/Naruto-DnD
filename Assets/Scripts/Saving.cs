...
public class Saving : MonoBehaviour
{
    ...
    public void save(bool justSave)
    {
        ...
        if (player.playerName != "")
        {
            ...
            {
                if (e.ToString().Contains("UnauthorizedAccess"))
                {
                    errorMessage.text = "This application does not have access.  Please re-run as administrator and try again.";
                }
                else
                {
                    print(e.ToString());
                    errorMessage.text = "There was an unkown error saving the character....";
                }
            }
